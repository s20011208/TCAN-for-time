...
def get_dataInfo(dataname):
    data_path = "D:/BaiduNetdiskDownload/code/sales/RNN prediction/Explicit Time Embedding/dataset"
    if dataname == "weibo":
        observation_time = 3600 * 1
        prediction_time = [12 * 3600]
    elif dataname == "aps":
...
cascade_filtered_path = data_path + '/dataset_filtered1.txt'
cascade_sorted_filtered_path = data_path + '/dataset_sorted_filtered1.txt'

cascade_train = data_path + "/cascade_train1.txt"
cascade_validation = data_path + "/cascade_validation1.txt"
cascade_test = data_path + "/cascade_test1.txt"

cascade_shortestpath_train = data_path + "/cascade_shortestpath_train1.txt"
cascade_shortestpath_validation = data_path + "/cascade_shortestpath_validation1.txt"
cascade_shortestpath_test = data_path + "/cascade_shortestpath_test1.txt"

global_graph = data_path + "/global_graph1.pkl"
global_embedding = data_path + "/gg"

train = data_path + '/data_train1.pkl'
val = data_path + '/data_val1.pkl'
test = data_path + '/data_test1.pkl'
